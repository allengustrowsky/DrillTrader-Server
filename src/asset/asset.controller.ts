...
export class AssetController {
    ...
    @ApiConflictResponse({ description: 'Name and ticker symbol must be unique.' })
    ...
    @ApiConflictResponse({ description: 'At least one of the values provided that must be unique is already taken.' })
    @ApiInternalServerErrorResponse({ description: 'An internal server error occurred.' })
