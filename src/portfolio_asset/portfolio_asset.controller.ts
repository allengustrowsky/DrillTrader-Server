...
import { ApiBadRequestResponse, ApiConflictResponse, ApiMethodNotAllowedResponse, ApiNotFoundResponse, ApiOkResponse, ApiTags } from '@nestjs/swagger';
...
export class PortfolioAssetController {
    ...
    @ApiBadRequestResponse({ description: 'Unites must not be less than zero.' })
    ...
    @ApiConflictResponse({ description: 'Portfolio asset of this type for this user\'s portfolio already exists.'})
    ...
    @Get('/user/:id')
    @ApiOkResponse({ description: 'Successfully returned resources.' })
    @ApiMethodNotAllowedResponse({ description: 'You are not allowed to access this user\'s portfolio assets.' })
    ...
    @ApiNotFoundResponse({ description: 'Portfolio asset with this id not found.' })
    @ApiMethodNotAllowedResponse({ description: 'You are not allowed to access this user\'s portfolio assets.' })
