...
export class PortfolioValueController {
  constructor(private readonly portfolioValueService: PortfolioValueService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePortfolioValueDto: UpdatePortfolioValueDto) {
