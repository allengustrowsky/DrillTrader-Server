...
import { LivePriceDataService, AssetList } from '../live_price_data/live_price_data.service';
...
//   }
  ...
  async findOne(id: number) {
    ...
    if (!asset) {
        throw new HttpException(`Asset with id ${id} not found.`, HttpStatus.NOT_FOUND)
    }
    return {
