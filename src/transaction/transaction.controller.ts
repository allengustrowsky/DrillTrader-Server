...
import { ApiBadRequestResponse, ApiForbiddenResponse, ApiNotFoundResponse, ApiOkResponse, ApiTags, ApiTooManyRequestsResponse } from '@nestjs/swagger';
...
export class TransactionController {
    ...
    @ApiBadRequestResponse({ description: 'You do not have enough cash to withdraw.' })
    @ApiTooManyRequestsResponse({ description: 'API limit reached. Please wait a for a minute to continue using the API.'})
    @ApiBadRequestResponse({ description: 'You do not have enough cash to make this transaction.' })
    @ApiBadRequestResponse({ description: 'You do not have any units of this asset to sell.' })
    @ApiBadRequestResponse({ description: 'You do not have enough units of this asset to sell.' })
    ...
    @ApiForbiddenResponse({ description: 'You are not allowed to access this user\' transactions.' })
